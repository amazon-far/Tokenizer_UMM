...
def tokenize_batch(batch, image_tokenizer, rank=0):
    ...
    try:
        ...
        with torch.no_grad():
            _, _, [_, _, img_toks] = image_tokenizer._vq_model.encode(images)
...
def load_and_tokenize_distributed(rank, world_size, folder_path,
    ...
    try:
        ...
        image_tokenizer = ImageTokenizer(  cfg_path=REPO_ROOT + "/data/tokenizer/vqgan.yaml",
                                          ckpt_path=REPO_ROOT + "/data/tokenizer/vqgan.ckpt", 
