...
def main(args):
    ...
    urls = urls[:int(len(urls) * 0.02)]  # 0.015
...
# python convert_DCLM_local_data_multiprocessing.py --temp-path /tmp/dclm30m --save-path /path/to/data/dclm30m_hf