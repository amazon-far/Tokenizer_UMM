...
def worker_process(rank, args, dataset_path, world_size):
    ...
    for start_index in tqdm(range(0, len(subset), args.batch_size), desc=f"GPU {rank} processing"):
        ...
        batch_results = process_item(batch, encoder, device=device)
...
# python genai_ibq.py --input_pairs /path/to/data/siting/GenAI-Bench-527 --save_path /path/to/data/GenAI-Bench-527_tokenized_ibq_1024 --temp_path /tmp/genai_bench_527_jsonl_ibq_1024 --vocab_size 1024