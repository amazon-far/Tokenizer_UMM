...
def tokenize_batch(batch, encoder, rank=0):
    ...
    try:
        ...
        with torch.no_grad():
            quant, qloss, (_, _, indices) = encoder.encode(images)
...
# python tokenize_to_jsonl_journeydb_ibq.py --folder_path /path/to/data/predownloaded/datasets/Liquid/journeydb_ingest_all/parquet/validation/ --output_dir /path/to/data/journeydb_val_tokenized_ibq_1024