...
# python genai_gigatok.py --input_pairs /path/to/data/siting/GenAI-Bench-527 --save_path /path/to/data/siting/GenAI-Bench-527_tokenized_gigatok --temp_path /tmp/genai_bench_527_jsonl_gigatok 