...
def worker_process(rank, args, dataset_path, world_size):
    ...
    for start_index in tqdm(range(0, len(subset), args.batch_size), desc=f"GPU {rank} processing"):
        ...
        batch_results = process_item(batch, image_tokenizer, args.source_name, image_folder=None, device=device)
...
# python blip3o_gigatok_dino.py --input_pairs /path/to/data/BLIP3o_60k --save_path /path/to/data/blip3o_60k_tokenized_gigatok_dino --temp_path /tmp/blip3o_60k_jsonl_gigatok_dino --source_name blip3o-60k
# python blip3o_gigatok_dino.py --input_pairs /path/to/data/BLIP3o_60k_short --save_path /path/to/data/blip3o_60k_short_tokenized_gigatok_dino --temp_path /tmp/blip3o_60k_short_jsonl_gigatok_dino --source_name blip3o-60k-short
