...
# python tokenize_to_jsonl_laion_gigatok.py --folder_path /path/to/data/filtered_laion_aesthetics_parquet_recaptioned/val.parquet --output_dir /path/to/data/laion_val_recap_tokenized_gigatok