...
export PROJECT_ROOT="/path/to/Liquid/evaluation/GigaTok"
...
export EVAL_PYTHON_PATH="/path/to/data/miniconda3/envs/gigatok/bin/python"
...
export TORCH_RUN_PATH="/path/to/data/miniconda3/envs/gigatok/bin/torchrun"
