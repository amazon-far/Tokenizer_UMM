...
# python blip3o_gigatok.py --input_pairs /path/to/data/BLIP3o_60k --save_path /path/to/data/blip3o_60k_tokenized_gigatok --temp_path /tmp/blip3o_60k_jsonl_gigatok --source_name blip3o-60k
# python blip3o_gigatok.py --input_pairs /path/to/data/BLIP3o_60k_short --save_path /path/to/data/blip3o_60k_short_tokenized_gigatok --temp_path /tmp/blip3o_60k_short_jsonl_gigatok --source_name blip3o-60k-short
